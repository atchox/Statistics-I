...
\begin{document}
\textbf{Question:}
\textit{Produce a Pareto diagram of the variable countries in Forbes2000 data. Submit the R code and the plot.}
\vspace{1em}
\begin{figure*}[h]
  \centering
  \includegraphics[width=13cm]{countryPareto.png}
  \caption{Pareto Chart of Forbes2000 Countries}
\end{figure*}
\newpage
